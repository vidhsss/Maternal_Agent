# Semantic + heirchical chunking based vectore store loading
...
"""
EnhancedMedicalRAG.py
--------------------
Enhanced RAG system for maternal health with multilingual support, stage-aware retrieval, and cross-encoder reranking.

Usage:
    python EnhancedMedicalRAG.py --question "Your question here" --vector_store_path <path> --model_name <hf_model_name>
"""
