...
HMC_FAISS_VS.py
--------------
Provides a FAISS vector store with hierarchical chunking and text-embedding-ada-002 embedding for medical documents.
This module is used for processing documents into hierarchical chunks and storing them in a FAISS vector database for retrieval.
